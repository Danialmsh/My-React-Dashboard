...
const Index = () => {
    const { showSidebar, ToggleShowSidebar } = useContext(AdminContext);

    return (
        <section
            id="sidebar_section"
            className={`${ToggleShowSidebar ? "d-flex" : ""}`}
            onClick={(e) => e.stopPropagation()}
        >
            <div className={`mini_sidebar collapsedd h-100 ${showSidebar ? "expanded" : ""} ${ToggleShowSidebar ? "expanded" : ""}`}>
                <ToggleSideBarButton />
                ...
                <div className="sidebar_items_container">
                    <SidebarGroupTitle title="فروشگاه" pTitles={["read_categories", "read_products", "read_brands", "read_guaranties", "read_colors", "read_discounts"]} icon="fas fa-stream">
                    ...
                    <SidebarGroupTitle title="سفارشات و سبد" pTitles={["read_carts", "read_orders", "read_deliveries"]} icon="fas fa-shopping-basket">
                    ...
                    <SidebarGroupTitle title="کاربران و همکاران" pTitles={["read_users", "read_roles", "read_permissions"]} icon="fas fa-users">
                    ...
                    <SidebarGroupTitle title="ارتباطات" pTitles={["read_questions", "read_comments"]} icon="fas fa-question-circle">
